...
/**
	Exporte le schema vers une QImage
	@param image L'image de destination
	@param width Largeur de l'image
	@param height Hauteur de l'image
	@param aspectRatioMode Mode de ratio d'aspect
*/
void Diagram::toImage(QImage &image, int width, int height, Qt::AspectRatioMode aspectRatioMode)
{
	toPaintDevice(image, width, height, aspectRatioMode);
}
