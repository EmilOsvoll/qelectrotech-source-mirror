...
QString QETInformation::translatedInfoKey(const QString &info)
{
	...
	else if (info == DIA_PLANT)                        return QObject::tr("Facility (=)");
	...
	else if (info == PROJECT_FOLIO_TOTAL)              return QObject::tr("Total folio count");
	else if (info == DIA_PREVIOUS_FOLIO_NUM)           return QObject::tr("Previous folio number");
	else if (info == DIA_NEXT_FOLIO_NUM)               return QObject::tr("Next folio number");
	...
	else if (info == ELMT_DESCRIPTION)                 return QObject::tr("Text description");
	...
	else if (info == ELMT_UNITY)                       return QObject::tr("Unit");
	...
	else if (info == COND_COLOR)                       return QObject::tr("Conductor color");
	else if (info == COND_SECTION)                     return QObject::tr("Conductor cross section");
	...
	else if (info == ELMT_DESCRIPTION_AUX1)                 return QObject::tr("Auxiliary text description 1");
	else if (info == ELMT_DESIGNATION_AUX1)                 return QObject::tr("Auxiliary article number 1");
	else if (info == ELMT_MANUFACTURER_AUX1)                return QObject::tr("Auxiliary manufacturer 1");
	else if (info == ELMT_MANUFACTURER_REF_AUX1)            return QObject::tr("Auxiliary order number 1");
	else if (info == ELMT_MACHINE_MANUFACTURER_REF_AUX1)    return QObject::tr("Auxiliary internal number 1");
	else if (info == ELMT_SUPPLIER_AUX1)                    return QObject::tr("Auxiliary supplier 1");
	else if (info == ELMT_QUANTITY_AUX1)                    return QObject::tr("Auxiliary quantity 1");
	else if (info == ELMT_UNITY_AUX1)                       return QObject::tr("Auxiliary unity 1");
	else if (info == ELMT_AUX2)                        return QObject::tr("Auxiliary block 2");
	else if (info == ELMT_DESCRIPTION_AUX2)                 return QObject::tr("Auxiliary text description 2");
	else if (info == ELMT_DESIGNATION_AUX2)                 return QObject::tr("Auxiliary article number 2");
	else if (info == ELMT_MANUFACTURER_AUX2)                return QObject::tr("Auxiliary manufacturer 2");
	else if (info == ELMT_MANUFACTURER_REF_AUX2)            return QObject::tr("Auxiliary order number 2");
	else if (info == ELMT_MACHINE_MANUFACTURER_REF_AUX2)    return QObject::tr("Auxiliary internal number 2");
	else if (info == ELMT_SUPPLIER_AUX2)                    return QObject::tr("Auxiliary supplier 2");
	else if (info == ELMT_QUANTITY_AUX2)                    return QObject::tr("Auxiliary quantity 2");
	else if (info == ELMT_UNITY_AUX2)                       return QObject::tr("Auxiliary unity 2");
	else if (info == ELMT_AUX3)                        return QObject::tr("Auxiliary block 3");
	else if (info == ELMT_DESCRIPTION_AUX3)                 return QObject::tr("Auxiliary text description 3");
	else if (info == ELMT_DESIGNATION_AUX3)                 return QObject::tr("Auxiliary article number 3");
	else if (info == ELMT_MANUFACTURER_AUX3)                return QObject::tr("Auxiliary manufacturer 3");
	else if (info == ELMT_MANUFACTURER_REF_AUX3)            return QObject::tr("Auxiliary order number 3");
	else if (info == ELMT_MACHINE_MANUFACTURER_REF_AUX3)    return QObject::tr("Auxiliary internal number 3");
	else if (info == ELMT_SUPPLIER_AUX3)                    return QObject::tr("Auxiliary supplier 3");
	else if (info == ELMT_QUANTITY_AUX3)                    return QObject::tr("Auxiliary quantity 3");
	else if (info == ELMT_UNITY_AUX3)                       return QObject::tr("Auxiliary unity 3");
	else if (info == ELMT_AUX4)                        return QObject::tr("Auxiliary block 4");
	else if (info == ELMT_DESCRIPTION_AUX4)                 return QObject::tr("Auxiliary text description 4");
	else if (info == ELMT_DESIGNATION_AUX4)                 return QObject::tr("Auxiliary article number 4");
	else if (info == ELMT_MANUFACTURER_AUX4)                return QObject::tr("Auxiliary manufacturer 4");
	else if (info == ELMT_MANUFACTURER_REF_AUX4)            return QObject::tr("Auxiliary order number 4");
	else if (info == ELMT_MACHINE_MANUFACTURER_REF_AUX4)    return QObject::tr("Auxiliary internal number 4");
	else if (info == ELMT_SUPPLIER_AUX4)                    return QObject::tr("Auxiliary supplier 4");
	else if (info == ELMT_QUANTITY_AUX4)                    return QObject::tr("Auxiliary quantity 4");
	else if (info == ELMT_UNITY_AUX4)                       return QObject::tr("Auxiliary unity 4");
	else return QString();
}
