...
void QETApp::checkBackupFiles()
{
	...
	if(stale_files.size() == 1) {
		text.append(tr("<b>The following restore file was found,<br>"
					   "Do you want to open it ?</b><br>"));
	} else {
		text.append(tr("<b>The following restoration files were found,<br>"
					   "Do you want to open them ?</b><br>"));
	}
...
void QETApp::printHelp()
{
	QString help(
		...
		+ tr(" [options] [fichier]...\n\n")
		+ tr("QElectroTech, an application to design electrical schematics.\n\n"
		"Options disponibles : \n"
...
#endif
#ifdef QET_ALLOW_OVERRIDE_CTBTD_OPTION
		+ tr("  --common-tbt-dir=DIR          Set the title block template collection directory\n")
#endif
#ifdef QET_ALLOW_OVERRIDE_CD_OPTION
