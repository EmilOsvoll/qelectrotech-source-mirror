...
void CustomElementGraphicPart::stylesToXml(QDomElement &qde) const
{
	...
	static const QMap<Filling, QString> filling_map = {
		...
		{HTMLPinkToepPinkFilling, "HTMLPinkToepPink"},
		{HTMLPinkPalePurpleRedFilling, "HTMLPinkPalePurpleRed"},
		{HTMLPinkMediumPurpleRedFilling, "HTMLPinkMediumPurpleRed"},
		...
		{HTMLBrownWhitehedAlmondFilling, "HTMLBrownWhitehedAlmond"},
		...
		{HTMLBlueToepSkyBlueFilling, "HTMLBlueToepSkyBlue"},
		...
		{HTMLPurpleBluePurpleFilling, "HTMLPurpleBluePurple"},
		{HTMLPurpleDarkPurpleFilling, "HTMLPurpleDarkPurple"},
	...
	static const QMap<Color, QString> color_map = {
		...
		{HTMLPinkToepPinkColor, "HTMLPinkToepPink"},
		{HTMLPinkPalePurpleRedColor, "HTMLPinkPalePurpleRed"},
		{HTMLPinkMediumPurpleRedColor, "HTMLPinkMediumPurpleRed"},
		...
		{HTMLBrownWhitehedAlmondColor, "HTMLBrownWhitehedAlmond"},
		...
		{HTMLBlueToepSkyBlueColor, "HTMLBlueToepSkyBlue"},
		...
		{HTMLPurpleBluePurpleColor, "HTMLPurpleBluePurple"},
		{HTMLPurpleDarkPurpleColor, "HTMLPurpleDarkPurple"},
	...
	for (auto style : styles)
	{
		...
		else if (style_name == "filling")
		{
			static const QMap<QString, Filling> filling_map = {
				...
				{"HTMLPinkToepPink", HTMLPinkToepPinkFilling},
				{"HTMLPinkPalePurpleRed", HTMLPinkPalePurpleRedFilling},
				{"HTMLPinkMediumPurpleRed", HTMLPinkMediumPurpleRedFilling},
				...
				{"HTMLBrownWhitehedAlmond", HTMLBrownWhitehedAlmondFilling},
				...
				{"HTMLBlueToepSkyBlue", HTMLBlueToepSkyBlueFilling},
				...
				{"HTMLPurpleBluePurple", HTMLPurpleBluePurpleFilling},
				{"HTMLPurpleDarkPurple", HTMLPurpleDarkPurpleFilling},
		...
		else if (style_name == "color")
		{
			static const QMap<QString, Color> color_map = {
				...
				{"HTMLPinkToepPink", HTMLPinkToepPinkColor},
				{"HTMLPinkPalePurpleRed", HTMLPinkPalePurpleRedColor},
				{"HTMLPinkMediumPurpleRed", HTMLPinkMediumPurpleRedColor},
				...
				{"HTMLBrownWhitehedAlmond", HTMLBrownWhitehedAlmondColor},
				...
				{"HTMLBlueToepSkyBlue", HTMLBlueToepSkyBlueColor},
				...
				{"HTMLPurpleBluePurple", HTMLPurpleBluePurpleColor},
				{"HTMLPurpleDarkPurple", HTMLPurpleDarkPurpleColor},
...
void CustomElementGraphicPart::applyStylesToQPainter(QPainter &painter) const
{
	...
	else
	{
		static const QMap<Filling, QColor>
			filling_style_map = {
				...
				{HTMLPinkToepPinkFilling, QColor(255, 20, 147)},
				{HTMLPinkPalePurpleRedFilling, QColor(219, 112, 147)},
				{HTMLPinkMediumPurpleRedFilling, QColor(199, 21, 133)},
				...
				{HTMLBrownWhitehedAlmondFilling, QColor(255, 235, 205)},
				...
				{HTMLBlueToepSkyBlueFilling, QColor(0, 191, 255)},
				...
				{HTMLPurpleBluePurpleFilling, QColor(138, 43, 226)},
				{HTMLPurpleDarkPurpleFilling, QColor(148, 0, 211)},
	...
	static const QMap<Color, QColor> color_map =
		{{GreenColor, Qt::green},
		 ...
		 {HTMLPinkToepPinkColor, QColor(255, 20, 147)},
		 {HTMLPinkPalePurpleRedColor, QColor(219, 112, 147)},
		 {HTMLPinkMediumPurpleRedColor, QColor(199, 21, 133)},
		 ...
		 {HTMLBrownWhitehedAlmondColor, QColor(255, 235, 205)},
		 ...
		 {HTMLBlueToepSkyBlueColor, QColor(0, 191, 255)},
		 ...
		 {HTMLPurpleBluePurpleColor, QColor(138, 43, 226)},
		 {HTMLPurpleDarkPurpleColor, QColor(148, 0, 211)},
