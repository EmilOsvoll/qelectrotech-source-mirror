			...
			if (m_edited_type == 2)
			{
				QMessageBox::information (
							...
							tr("Folio Auto Numbering",
							   "title window"),
							tr("This is where you can define how new folios will be numbered.\n"
							   ...
							   "this will be preceded by one or two 0s in order to respect its type.\n"
			...
			else if (m_edited_type == 1)
			{
				QMessageBox::information (
							...
							tr("Conductor Auto Numbering",
							   "title window"),
							tr("This is where you can define how new drivers will be numbered.\n"
							   "-A numbering is composed of a minimum variable.\n"
							   "-You can add or remove a numbering variable using the - and + buttons.\n"
							   "-A numbering variable consists of: a type, a value, and an increment.\n"
			...
			else
			{
				QMessageBox::information (
							...
							tr("Element Auto Numbering",
							   "title window"),
							tr("This is where you can define how new items will be numbered.\n"
							   "-A numbering is composed of a minimum variable.\n"
							   "-You can add or remove a numbering variable using the - and + buttons.\n"
							   "-A numbering variable consists of: a type, a value, and an increment.\n"
